...
- (UILabel *)alterLabel {
    if (!_alterLabel) {
        ...
        _alterLabel.textColor = [UIColor colorWithHexString:@"#333333"];
...
- (UIView *)breakLine {
    if (!_breakLine) {
        ...
        _breakLine.backgroundColor = [UIColor colorWithHexString:@"#DDDDDD"];
    }
    return _breakLine;
}
...
- (UIButton *)cancelBtn {
    if (!_cancelBtn) {
        ...
        [_cancelBtn  setTitleColor:[UIColor colorWithHexString:@"#309CF5"] forState:UIControlStateNormal];
...
- (UIView *)middleBreakLine {
    if (!_middleBreakLine) {
        ...
        _middleBreakLine.backgroundColor = [UIColor colorWithHexString:@"#DDDDDD"];
    }
...
- (UIButton *)enterBtn {
    if (!_enterBtn) {
        ...
        [_enterBtn setTitleColor:[UIColor colorWithHexString:@"#666666"] forState:UIControlStateNormal];
